...
# count() counts how many letters there are in a string
...
sent="Controlling complexity is the essence of programming"
print(sent[:11])
...
sent ="Never trust a computer you can't throw out a window"
print(sent[9::3])
...
sent="It's great to work with computers. They don't argue, they remember everything and they don't drink your beer"
print(sent[::-1])
